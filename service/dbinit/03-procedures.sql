...
BEGIN
    ...
    SELECT ut.`uye_tahakkuk_id`,ut.`yil`,ut.`ay`,ut.`tahakkuk_tarih`,ut.`borc`,t.tanim , m.`tutar`,m.`tarih`, 
    ...
    LEFT JOIN yoklama y on y.yoklama_id = ut.yoklama_id 
	    WHERE ut.`uye_id` = p_uye_id and ut.muhasebe_id  is NULL ORDER BY tahakkuk_tarih DESC;
