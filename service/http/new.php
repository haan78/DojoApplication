...
<div class="item">
    <label style="width: 100%">
        <span class="labelinfo">E-Posta</span>
        <input name="ad" type="text" placeholder="E-Posta" autocomplete="off" />
        <span class="labelinfo">Kayıt işleminde eposta adresi doğrulanacaktır. Lütfen geçerli, size ait ve kullandığınz bir eposta adresi belirtin</i>
    </label>
</div>
...
<div class="item">
    ...
    <div class="item">
    <label style="width: 100%">
        <span class="labelinfo">Ciddi bir sağlık sorununuz var mı? Varsa belirtiniz.</span>
        <textarea name="saglik"></textarea>
    </label>
</div>
...
<div class="item">
    <label style="cursor: pointer;width: 100%;"><input type="checkbox" name="onay" onchange="" />Yukarıda belirttiğim bilgilerin doğruluunu onaylıyorum.</label>
</div>
